...
-- PAYMENTS
--
-- Payment initialization lives in Vercel server-side routes (api/*). They call
-- record_pending_payment (creates the pending row) and credit_payment (idempotent
-- credit + welcome bonus). Secrets stay ONLY in Vercel env vars — nothing here.
--
